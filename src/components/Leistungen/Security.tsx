  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 gap-10 lg:grid-cols-2">
        ...
        <img
          src="https://bilder.computer-extra.de/data/Website/GData.webp"
          alt="G Data Logo"
      ...
      <div className="grid grid-cols-1 gap-10 lg:grid-cols-2">
        <div>
          <p className="leading-7 not-first:mt-6">
            Netzwerksicherheit - Made in Germany
          </p>
          <p className="leading-7 not-first:mt-6">
      ...
      <div className="cList mt-5">
        <ul className="grid grid-cols-1 items-center gap-10 leading-snug md:grid-cols-2">
          <li>
            <span>
      ...
      <div className="grid grid-cols-1 gap-10 lg:grid-cols-2">
        ...
        <div className="cList mt-5">
          <ul className="grid grid-cols-1 items-center gap-10 leading-snug">
            <li>
              <span>
