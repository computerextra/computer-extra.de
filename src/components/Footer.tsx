...
export const Footer = () => {
  return (
    <div className={`w-full bg-slate-700 pb-12.5 md:pb-0`}>
        ...
        <div className="grid grid-cols-4 justify-items-center lg:justify-items-start">
          ...
          >
            ...
            >
              ...
              ></path>
              <linearGradient
                id="vc8QRGE7FrZm_4whYbQGXb_123743_gr2"
                x1="31.015"
                x2="31.015"
                y1="14.405"
                y2="49.732"
              ...
              <path
                ...
                d="M34,49V34h5.001l1.03-6L34,28.019V23.93c0-1.743-0.109-2.93,2.39-2.93L40,20.999 l0.005-5.731c-0.845-0.074-2.273-0.238-4.512-0.238c-4.675,0-7.493,2.817-7.493,7.989V28h-6v6h6v15H34z"
              ></path>
            </svg>
          </a>
          <a
      ...
      <div className="w-full text-center text-sm font-thin text-slate-200">
