      ...
      <MainLayout title="Datenschutz&shy;erklärung" subtitle="">
        ...
        <div className="text-xl">
          <p className="py-1">
            ...
            Geschäftsleitung der Computer Extra GmbH. Eine Nutzung der
            Internetseiten der Computer Extra GmbH ist grundsätzlich ohne jede
          ...
          <p className="py-1 text-xl">
            ...
            Computer Extra GmbH geltenden landesspezifischen
          ...
          <p className="py-1 text-xl">
            Die Computer Extra GmbH hat als für die Verarbeitung
          ...
          <p className="py-1">
            Die Datenschutzerklärung der Computer Extra GmbH beruht auf den
          ...
          <ul>
            <li>
              <h3 className="font-medium text-xl mb-2 mt-5">
            ...
            <li>
              <h3 className="font-medium text-xl mb-2 mt-5">c) Verarbeitung</h3>
              <p className="py-1">
            ...
            <li>
              <h3 className="font-medium text-xl mb-2 mt-5">e) Profiling</h3>
              <p className="py-1">
            ...
            <li>
              <h3 className="font-medium text-xl mb-2 mt-5">i) Empfänger</h3>
              <p className="py-1">
            ...
            <li>
              <h3 className="font-medium text-xl mb-2 mt-5">j) Dritter</h3>
              <p className="py-1">
            ...
            <li>
              <h3 className="font-medium text-xl mb-2 mt-5">k) Einwilligung</h3>
              <p className="py-1">
          ...
          <p className="py-1">
            ...
            DE / Hessen <br />
            Tel.: 0561601440 <br />
            E-Mail: info [at] computer-extra [punkt] de <br />
            Website: https://computer-extra.de
          </p>
          <h2 className="font-medium text-2xl mb-2 mt-5">
          ...
          <p className="py-1">
            ...
            DE / Hessen <br />
            Tel.: 056160144121 <br />
            E-Mail: johannes [punkt] kirchner [at] computer-extra [punkt] de{" "}
            <br />
            Website: https://computer-extra.de <br />
          </p>
          <p className="py-1">
          ...
          <p className="py-1">
            Die Internetseite der Computer Extra GmbH erfasst mit jedem Aufruf
          ...
          <p className="py-1">
            ...
            Computer Extra GmbH keine Rückschlüsse auf die betroffene Person.
            ...
            anonym erhobenen Daten und Informationen werden durch die Computer
            Extra GmbH daher einerseits statistisch und ferner mit dem Ziel
          ...
          <p className="py-1">
            Die Internetseite der Computer Extra GmbH enthält aufgrund von
          ...
          <ul>
            ...
            <li>
              ...
              <p className="py-1">
                ...
                bei der Computer Extra GmbH gespeichert sind, veranlassen
                ...
                der Computer Extra GmbH wird veranlassen, dass dem
                Löschverlangen unverzüglich nachgekommen wird.
              </p>

              <p className="py-1">
                Wurden die personenbezogenen Daten von der Computer Extra GmbH
                öffentlich gemacht und ist unser Unternehmen als
                Verantwortlicher gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der
                personenbezogenen Daten verpflichtet, so trifft die Computer
                Extra GmbH unter Berücksichtigung der verfügbaren Technologie
                ...
                Computer Extra GmbH wird im Einzelfall das Notwendige
                veranlassen.
              </p>
            </li>
            <li>
              ...
              <p className="py-1">
                ...
                Daten, die bei der Computer Extra GmbH gespeichert sind,
                verlangen möchte, kann sie sich hierzu jederzeit an einen
                Mitarbeiter des für die Verarbeitung Verantwortlichen wenden.
                Der Mitarbeiter der Computer Extra GmbH wird die Einschränkung
            ...
            <li>
              ...
              <p className="py-1">
                Die Computer Extra GmbH verarbeitet die personenbezogenen Daten
              ...
              <p className="py-1">
                Verarbeitet die Computer Extra GmbH personenbezogene Daten, um
                ...
                betroffene Person gegenüber der Computer Extra GmbH der
                Verarbeitung für Zwecke der Direktwerbung, so wird die Computer
                Extra GmbH die personenbezogenen Daten nicht mehr für diese
                Zwecke verarbeiten.
              </p>
              ...
              <p className="py-1">
                ...
                Computer Extra GmbH zu wissenschaftlichen oder historischen
              ...
              <p className="py-1">
                ...
                Person direkt an jeden Mitarbeiter der Computer Extra GmbH oder
                einen anderen Mitarbeiter wenden. Der betroffenen Person steht
            ...
            <li>
              ...
              <p className="py-1">
                ...
                Computer Extra GmbH angemessene Maßnahmen, um die Rechte und
          ...
          <p className="py-1">
            ...
            Bewerber entsprechende Bewerbungsunterlagen auf dem elektronischen
            ...
            Verantwortliche einen Anstellungsvertrag mit einem Bewerber, werden
          ...
          <h2 className="font-medium text-2xl mb-2 mt-5">
            9. Datenschutzbestimmungen zu Einsatz und Verwendung von externen
            Links
          </h2>
          <p className="py-1">
            Innerhalb unserer Internetseite wird auch auf Internetseiten Dritter
            verwiesen. Diese werden in der Regel durch Angabe der
            Internetadresse oder Darstellung des Logos kenntlich gemacht. Wir
            haben keinen Einfluss auf den Inhalt und die Gestaltung dieser
            Internetseiten anderer Anbieter und können daher den Inhalt dieser
            Datenschutzerklärung nicht auf solche Internetseiten Dritter
            ausdehnen.
          </p>
          <h2 className="font-medium text-2xl mb-2 mt-5">
          ...
          <p className="py-1">
            ...
            Nutzung dieser Internetseite auszuwerten, um Online-Reports, welche
          ...
          <h2 className="font-medium text-2xl mb-2 mt-5">16. Hosting</h2>
          <p className="py-1">
            Wir hosten die Inhalte unserer Website bei folgendem Anbieter:
          </p>
          <p className="py-1">
            <strong>All-Inkl</strong>
          </p>
          <p className="py-1">
          ...
          <p className="py-1">
            ...
            <a
              ...
              className="underline"
            >
              LegalTech <ExternalLink />
            </a>{" "}
            Spezialisten von Willing & Able, die auch das System für{" "}
            <a
              href="https://abletorecords.com/"
              target="_blank"
              rel="noopener noreferrer"
              className="underline"
            >
              digitale Verfahrensverzeichnisse <ExternalLink />
            </a>{" "}
            ...
            <a
              ...
              className="underline"
            >
              Prof. Dr. h.c. Heiko Jonny Maniero <ExternalLink />
            </a>{" "}
            und Rechtsanwalt{" "}
            <a
              ...
              className="underline"
            >
              Christian Solmecke <ExternalLink />
            </a>{" "}
