      ...
      <div className={"custom"}>
        <div className="custom">
          ...
          <p>
            ...
            Person" einen Überblick über die Verarbeitung Ihrer
            personenbezogenen Daten durch uns und Ihre Rechte aus den
            Datenschutzgesetzen geben. Eine Nutzung unserer Internetseiten ist
            grundsätzlich ohne Eingabe personenbezogener Daten möglich. Sofern
            Sie besondere Services unseres Unternehmens über unsere
            Internetseite in Anspruch nehmen möchten, könnte jedoch eine
          ...
          <p>
            ...
            Übereinstimmung mit den für die "Computer Extra GmbH" geltenden
          ...
          <p>
            ...
            gewährleistet werden kann. Aus diesem Grund steht es Ihnen frei,
            personenbezogene Daten auch auf alternativen Wegen, beispielsweise
            telefonisch oder per Post, an uns zu übermitteln.
          </p>
          <p>
            Auch Sie können einfache und leicht umzusetzende Maßnahmen
            ergreifen, um sich gegen den unbefugten Zugang Dritter zu Ihren
            Daten zu schützen. Daher möchten wir Ihnen an dieser Stelle einige
            Hinweise zum sicheren Umgang mit Ihren Daten geben:
            <ul>
              <li>
                Schützen Sie Ihren Account (Login, Nutzer- oder Kundenkonto) und
                Ihr IT-System (Computer, Laptop, Tablet oder Mobile-Gerät) mit
            ...
            <p>
              Passwörter sollten aus mindestens 12 Zeichen bestehen und so
              gewählt werden, dass sie nicht leicht erraten werden können. Daher
              sollten sie keine gängigen Wörter aus dem Alltag, den eigenen
              Namen oder Namen von Verwandten, sondern Groß- und
              Kleinschreibung, Zahlen und Sonderzeichen enthalten.
            </p>
          ...
          <ol type="a">
            ...
            <li>
              ...
              Verarbeitung Verantwortlichen (unser Unternehmen) verarbeitet
              werden.
            </li>
            <li>
              <b>Verarbeitung</b>
          ...
          <p>
            Art. 6 Abs. 1 lit. a) DS-GVO (i.V.m. § 25 Abs. 1 TDDDG (ehem.
            TTDSG)) dient unserem Unternehmen als Rechtsgrundlage für
          ...
          <p>
            ...
            Art. 6 Abs. 1 lit. b) DS-GVO. Gleiches gilt für solche
          ...
          <p>
            ...
            schützen. Dies wäre beispielsweise der Fall, wenn ein Besucher in
          ...
          <p>
            ...
            anzunehmen sein könnte, wenn Sie ein Kunde unseres Unternehmens sind
            (Erwägungsgrund 47 Satz 2 DS-GVO).
          </p>
          <p>
            Unser Angebot richtet sich grundsätzlich an Erwachsene. Personen
            unter 16 Jahren dürfen ohne Zustimmung der Eltern oder
            ...
            und Jugendlichen an, sammeln diese nicht und geben sie nicht an
            Dritte weiter.
          </p>
          ...
          <ol>
            ...
            <li>
              die Weitergabe nach Art. 6 Abs. 1 lit. f) DS-GVO zur Wahrung
              unserer berechtigten Interessen zulässig ist und kein Grund zur
            ...
            <li>
              dies gesetzlich zulässig und nach Art. 6 Abs. 1 lit. b) DS-GVO für
              die Abwicklung von Vertragsverhältnissen mit Ihnen erforderlich
              ist.
            </li>
          </ol>
          <p>
            Um Ihre Daten zu schützen und uns gegebenenfalls eine
            Datenübermittlung in Drittländer (außerhalb der EU/des EWR) zu
            ermöglichen, haben wir Vereinbarungen zur Auftragsverarbeitung auf
            Grundlage der Standardvertragsklauseln der Europäischen Kommission
            abgeschlossen. Sofern die Standardvertragsklauseln nicht ausreichen,
            um ein adäquates Sicherheitsniveau herzustellen kann Ihre
            Einwilligung gemäß Art. 49 Abs. 1 lit. a) DS-GVO als Rechtsgrundlage
            für die Übermittlung in Drittländer dienen. Dies gilt mitunter nicht
            bei einer Datenübermittlung in Drittländer, für welche die
            Europäische Kommission einen Angemessenheitsbeschluss gemäß Art. 45
            DS-GVO ausgestellt hat.
          </p>
          <h2>7. Technik</h2>
          <h3>7.1 SSL/TLS-Verschlüsselung</h3>
          <p>
            Diese Seite nutzt zur <b>Gewährleistung</b> der Sicherheit der
            Datenverarbeitung und zum Schutz der Übertragung vertraulicher
            Inhalte, wie zum Beispiel Bestellungen, Login-Daten oder
            Kontaktanfragen, die Sie an uns als Betreiber senden, eine SSL-bzw.
            TLS-Verschlüsselung. Eine verschlüsselte Verbindung erkennen Sie
            daran, dass in der Adresszeile des Browsers statt einem "http://"
            ein "https://" steht und an dem Schloss-Symbol in Ihrer
            Browserzeile.
          </p>
          <p>
          ...
          <p>
            ...
            übermitteln oder keine Einwilligung in einwilligungspflichtige
            Verarbeitungen geben, erheben wir nur solche Daten, die für die
            Bereitstellung des Dienstes technisch unbedingt notwendig sind. Dies
            sind regelmäßig Daten, die Ihr Browser an unseren Server übermittelt
            ("in sog. Server-Logfiles"). Unsere Internetseite erfasst mit jedem
            Aufruf einer Seite durch Sie oder ein automatisiertes System eine
          ...
          <ol>
            ...
            <li>
              eine gekürzte Internet-Protokoll-Adresse (anonymisierte
              IP-Adresse) sowie,
            </li>
          ...
          <p>
            ...
            wir keine Rückschlüsse auf Ihre Person. Diese Informationen werden
          ...
          <ol>
            ...
            <li>
              die dauerhafte Funktionsfähigkeit unserer IT-Systeme und der
          ...
          <p>
            ...
            einerseits statistisch und andererseits mit dem Ziel ausgewertet,
          ...
          <p>
            Die Rechtsgrundlage für die Datenverarbeitung ist Art. 6 Abs. 1 lit.
            f) DS-GVO. Unser berechtigtes Interesse folgt aus oben aufgelisteten
            Zwecken zur Datenerhebung.
          </p>
          <h3>7.3 Hosting durch All-Inkl</h3>
          <p>
            Wir hosten unsere Website bei der ALL-INKL.COM - Neue Medien
            Münnich, Inh. René Münnich, Hauptstraße 68, 02742 Friedersdorf (im
            Weiteren All-Inkl genannt).
          </p>
          <p>
            Wenn Sie unsere Website besuchen, werden Ihre personenbezogenen
            Daten (z.B. IP-Adressen in Logfiles) auf den Servern von All-Inkl
            verarbeitet.{" "}
          </p>
          <p>
            Die Verwendung von All-Inkl erfolgt auf Grundlage von Art. 6 Abs. 1
            lit. f) DS-GVO. Wir haben ein berechtigtes Interesse an einer
            möglichst zuverlässigen Darstellung und Bereitstellung sowie
            Absicherung unserer Website.
          </p>
          <p>
            ...
            dass All-Inkl die personenbezogenen Daten unserer Webseitenbesucher
            nur nach unseren Weisungen und unter Einhaltung der DS-GVO
            verarbeitet.
          </p>
          <p>
            Nähere Informationen zu Datenschutzbestimmungen von All-Inkl finden
            Sie unter:{" "}
            <a
          ...
          <p>
            Über die Einstellungen Ihres verwendeten Browsers haben Sie
            jederzeit die Möglichkeit Cookies zu löschen, nur ausgewählte
            Cookies zuzulassen oder Cookies vollständig zu deaktivieren. Weitere
            Informationen erhalten Sie auf den Support-Seiten der jeweiligen
            Anbieter:
            <ul>
              <li>
                Chrome:{" "}
          ...
          <p>
            ...
            Cookiehinweis zu sehen und es werden keine Einwilligungen zur
            Nutzung von Cookies eingeholt.
          </p>
          ...
          <p>
            ...
            ausschließlich zum Zwecke der Beantwortung Ihres Anliegens bzw. für
            ...
            Beantwortung Ihres Anliegens gemäß Art. 6 Abs. 1 lit. f) DS-GVO.
            ...
            lit. b) DS-GVO. Ihre Daten werden nach abschließender Bearbeitung
            Ihrer Anfrage gelöscht, dies ist der Fall, wenn sich aus den
            Umständen entnehmen lässt, dass der betroffene Sachverhalt
            abschließend geklärt ist und der Löschung keine gesetzlichen
          ...
          <p>
            ...
            E-Mail oder über ein auf der Website befindliches Webformular, an
            uns übermittelt. Schließen wir einen Arbeits- oder Dienstvertrag mit
            einem Bewerber, werden die übermittelten Daten zum Zwecke der
            Abwicklung des Beschäftigungsverhältnisses unter Beachtung der
            gesetzlichen Vorschriften gespeichert. Wird von uns kein Vertrag mit
            dem Bewerber geschlossen, so werden die Bewerbungsunterlagen sechs
            ...
            unsererseits entgegenstehen. Ein sonstiges berechtigtes Interesse in
            diesem Sinne ist beispielsweise eine Beweispflicht in einem
            Verfahren nach dem Allgemeinen Gleichbehandlungsgesetz (AGG).
          </p>
          <p>
            Die Rechtsgrundlage der Verarbeitung Ihrer Daten ist Art. 6 Abs. 1
            lit. b), 88 DS-GVO i.V.m. § 26 Abs. 1 BDSG.
          </p>
          <h2>10. Unsere Aktivitäten in sozialen Netzwerken</h2>
          <p>
            Damit wir mit Ihnen auch in sozialen Netzwerken kommunizieren und
            Sie über unsere Leistungen informieren können, sind wir dort mit
            eigenen Seiten vertreten. Wenn Sie eine unserer Social-Media-Seiten
            besuchen, sind wir hinsichtlich der dadurch ausgelösten
            Verarbeitungsvorgänge, im Sinne des Art. 26 DS-GVO, mit dem Anbieter
            der jeweiligen Social-Media-Plattform gemeinsam für die Verarbeitung
            verantwortlich.
          </p>
          <p>
            Wir sind dabei nicht der originäre Anbieter dieser Seiten, sondern
            nutzen diese lediglich im Rahmen der uns durch die jeweiligen
            Anbieter gebotenen Möglichkeiten.
            <br />
            ...
            daher mit Datenschutzrisiken für Sie verbunden sein, da die Wahrung
            Ihrer Rechte z.B. auf Auskunft, Löschung, Widerspruch, etc.
            erschwert sein könnte und die Verarbeitung in den sozialen
            Netzwerken häufig direkt zu Werbezwecken oder zur Analyse des
            Nutzerverhaltens durch die Anbieter erfolgt, ohne dass dies durch
            uns beeinflusst werden kann. Werden durch den Anbieter
            Nutzungsprofile angelegt, werden dabei häufig Cookies eingesetzt
            bzw. das Nutzungsverhalten dem von Ihnen erstellten eigenen
            Mitgliedprofil der sozialen Netzwerke zugeordnet.
          </p>
          <p>
            Die beschriebenen Verarbeitungsvorgänge personenbezogener Daten
            erfolgen gemäß Art. 6 Abs. 1 lit. f) DS-GVO auf Basis unseres
            berechtigten Interesses und des berechtigten Interesses des
            jeweiligen Anbieters, um mit Ihnen in einer zeitgemäßen Art und
            Weise kommunizieren bzw. Sie über unsere Leistungen informieren zu
            können. Müssen Sie bei den jeweiligen Anbietern eine Einwilligung
            zur Datenverarbeitung als Nutzer abgeben, bezieht sich die
            Rechtsgrundlage auf Art. 6 Abs. 1 lit. a) DS-GVO i.V.m. Art. 7
            DS-GVO.
          </p>
          <p>
            Da wir keine Zugriffe auf die Datenbestände der Anbieter haben,
            weisen wir darauf hin, dass Sie Ihre Rechte (z.B. auf Auskunft,
            Berichtigung, Löschung, etc.) am besten direkt bei dem jeweiligen
            Anbieter gelten machen. Weiterführende Informationen zur
            Verarbeitung Ihrer Daten in den sozialen Netzwerken haben wir
            nachfolgend bei dem jeweiligen von uns eingesetzten Anbieter
          ...
          <p>
            ...
            volljähriger Nutzer aus der EU, z.B. Fotos, Beiträge oder
            Kommentare, zur Schulung eigener KI-Modelle verarbeiten. Grundlage
            ist ein berechtigtes Interesse gem. Art. 6 Abs. 1 lit. f) DS-GVO.
            Auf diese spezifische Datenverarbeitung durch Meta haben wir als
            Unternehmen keinen Einfluss. Nutzer können dem über ein
            Online-Formular auf den Meta-Plattformen widersprechen.
          </p>
          <p>
            Datenschutzerklärung (Datenrichtlinie):
            <br />
            <a href="https://www.facebook.com/about/privacy" rel="nofollow">
          ...
          <p>
            ...
            volljähriger Nutzer aus der EU, z.B. Fotos, Beiträge oder
            Kommentare, zur Schulung eigener KI-Modelle verarbeiten. Auf diese
            spezifische Datenverarbeitung durch Meta haben wir als Unternehmen
            keinen Einfluss. Grundlage ist ein berechtigtes Interesse gem. Art.
            6 Abs. 1 lit. f) DS-GVO. Nutzer können dem über ein Online-Formular
            auf den Meta-Plattformen widersprechen.
          </p>
          <p>
            Datenschutzerklärung (Datenrichtlinie):
            <br />
            <a href="https://instagram.com/legal/privacy/" rel="nofollow">
          ...
          <p>
            ...
            Informationen wie Zeitstempel, Klicks und Ihre Spracheinstellungen
            in verkürzter Form erfasst und weiterverarbeitet, wodurch ein
            direkter Personenbezug ausgeschlossen wird. Zudem werden die mittels
            PostHog ermittelten statistischen Daten nicht mit anderen von uns
            erhobenen Daten zusammengeführt.
          </p>

          <p>
            Die zeitlich begrenzte Verarbeitung und Speicherung dieser Daten
            findet grundsätzlich innerhalb der EU statt. Sollte eine
            Datenübermittlung aus der EU in Posthog’s AWS-Umgebung in den USA
            erforderlich sein, ist diese auf die EU-Standardvertragsklauseln
            (SCC) gestützt. Details dazu finden Sie hier:
          ...
          <p>
            ...
            meetergo). meetergo stellt ein Online-Terminvergabe-Tool bereit.
            Wenn Sie online einen Termin mit uns vereinbaren, werden Ihre hierzu
            eingegebenen Daten auf den Servern von meetergo in Deutschland
            gespeichert. Des Weiteren erfasst meetergo kurzfristig Ihre
            IP-Adresse, Ihre Referrer-URL, die Uhrzeit des Zugriffs und kann
            feststellen, dass Sie bei uns eine Anfrage gestellt haben; diese
            Daten werden ausschließlich für die technische Bereitstellung des
            Dienstes verwendet und anschließend automatisch wieder gelöscht. Die
            Verwendung von meetergo erfolgt auf Grundlage von Art. 6 Abs. 1 lit.
            f DSGVO. Der Websitebetreiber hat ein berechtigtes Interesse an
            einer möglichst unkomplizierten Terminvereinbarung. Sofern eine
            entsprechende Einwilligung abgefragt wurde, erfolgt die Verarbeitung
            ausschließlich auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO bzw.
          ...
          <p>
            ...
            der gesetzlich vorgesehenen Gründe zutrifft und soweit die
            Verarbeitung bzw. Speicherung nicht erforderlich ist.
          </p>
          ...
          <p>
            ...
            Behinderung durch uns, dem die personenbezogenen Daten
            bereitgestellt wurden, zu übermitteln, sofern die Verarbeitung auf
            der Einwilligung gemäß Art. 6 Abs. 1 lit. a) DS-GVO oder Art. 9 Abs.
            2 lit. a) DS-GVO oder auf einem Vertrag gemäß Art. 6 Abs. 1 lit. b)
            DS-GVO beruht und die Verarbeitung mithilfe automatisierter
            Verfahren erfolgt, sofern die Verarbeitung nicht für die Wahrnehmung
            einer Aufgabe erforderlich ist, die im öffentlichen Interesse liegt
            oder in Ausübung öffentlicher Gewalt erfolgt, welche uns übertragen
            wurde.
          </p>
          <p>
          ...
          <div style={{ border: "2px solid black" }}>
            ...
            <p>
              ...
              Interessen, Rechte und Freiheiten überwiegen, oder sofern die
            ...
            <p>
              ...
              Direktwerbung zu betreiben. Sie können jederzeit Widerspruch gegen
              ...
              solcher Direktwerbung in Verbindung steht. Widersprechen Sie
              gegenüber uns der Verarbeitung für Zwecke der Direktwerbung, so
              werden wir die personenbezogenen Daten nicht mehr für diese Zwecke
              verarbeiten.
            </p>
            <p>
            ...
            <p>
              Ihnen steht es frei, im Zusammenhang mit der Nutzung von Diensten
          ...
          <p>
            ...
            ist oder sofern dies durch die Rechtsvorschriften, welchen unser
            Unternehmen unterliegt, vorgesehen wurde.
          </p>
          <p>
          ...
          <p>
            ...
            der Website unter "https://computer-extra.de/Datenschutz" von Ihnen
