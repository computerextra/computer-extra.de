      ...
      {isScrolled && (
        <>
          <button
            ...
            } fixed bottom-[50px] right-[50px] p-3 bg-slate-200
          text-black font-medium text-xs leading-tight uppercase rounded-full 
          shadow-md hover:bg-blue-700 hover:text-white focus:text-white 
          active:text-white hover:shadow-lg focus:bg-blue-700 focus:shadow-lg z-[1000]
          ...
          <button
            ...
            onClick={backToTop}
            className={` ${
              isScrolled ? `md:hidden inline-block` : `hidden`
            } fixed bottom-0  w-max h-min inset-x-0 mx-auto px-6 pb-2 pt-3 bg-slate-200 text-black
           font-medium text-xs leading-tight uppercase rounded-t-full 
          shadow-md hover:bg-slate-300 
          active:text-white hover:shadow-lg focus:bg-slate-300 focus:shadow-lg z-[1000]
          focus:outline-none focus:ring-0 active:bg-slate-400 active:shadow-lg transition duration-150 ease-in-out`}
          >
            <div className="flex align-center justify-center items-center content-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                x="0px"
                y="0px"
